...
#include <dxcompat/comdecl.h>        // For DEFINE_CLSID and DEFINE_IID
...
#include <dxcompat/audiodefs.h>      // Basic audio data types and constants
#include <dxcompat/xma2defs.h>       // Data types and constants for XMA2 audio
